...
st.markdown("<h1 class='rounded-title'>Previsão de Preço de Carros</h1>", unsafe_allow_html=True)
...
""")
st.markdown("<h2 style='font-size: 25px; text-align: center;'>Insira as características do carro</h2>", unsafe_allow_html=True)
...
#ajustando butão de prever preço
st.markdown("""
    <style>
    .stButton button {
        width: 100%;
